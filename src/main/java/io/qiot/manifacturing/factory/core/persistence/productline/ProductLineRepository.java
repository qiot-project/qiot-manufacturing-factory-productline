package io.qiot.manifacturing.factory.core.persistence.productline;
...
public class ProductLineRepository {
    ...
    public List<ProductLineBean> findActiveProductLines(){
        return new ArrayList<ProductLineBean>();
    }
    public List<ProductLineBean> findAllProductLines(){
        return new ArrayList<ProductLineBean>();
    }
    public ProductLineBean findLastProductLine(){
        return new ProductLineBean();
    }
    public ProductLineBean findProductLineById(UUID id){
        return new ProductLineBean();
    }
